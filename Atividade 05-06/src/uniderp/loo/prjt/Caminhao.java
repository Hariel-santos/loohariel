...
public class Caminhao extends BasePorta{
    ...
    public Caminhao(int codigo, String nome, String modelo, int anoFabricacao, double pesoLiquido, String cor,
    ...
    public void Imprimir(){
        ...
        System.out.println("Acoplamento: " + this.acoplamento);
