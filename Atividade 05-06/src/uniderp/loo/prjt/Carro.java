...
public class Carro extends BasePorta{
    ...
    public Carro(int codigo, String nome, String modelo, int anoFabricacao, double pesoLiquido, String cor,
    ...
    public void Imprimir(){
        ...
        System.out.println("Diferencial: "+ this.diferencial);
